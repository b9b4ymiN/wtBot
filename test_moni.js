...
(async () => {
  let dataE = await getTransaction(
    "PQxPLQhXeGoANAcW3NuGAQ5cD9wjtWCz2fbEitFwznCnVinAxoBxM9cutBU71Ypu46oAoHDbWrJPUaUpw5X45Rj",
    "7EMdrCmpx7Pogha1r363176NQCMaWrwrReApvQTpmEd2"
  );
  console.log("data export:", dataE);
