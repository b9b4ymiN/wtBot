...
class TradeV2 extends base_1.Base {
    ...
    static getAllRouteComputeAmountOut({ inputTokenAmount, outputToken, directPath, routePathDict, simulateCache, tickCache, mintInfos, slippage, chainTime, epochInfo, feeConfig, }) {
        ...
        for (const itemPool of directPath) {
            try {
                outRoute.push(Object.assign(Object.assign({}, this.computeAmountOut1({
                    itemPool,
                    tickCache,
                    simulateCache,
                    chainTime,
            ...
            for (const iOutPool of info.out) {
                try {
                    ...
                    outRoute.push({
                        ...
                        executionPrice: new entity_1.Price(maxFirstIn.data.amountIn.amount.token, maxFirstIn.data.amountIn.amount.raw, outC.amountOut.amount.token, outC.amountOut.amount.raw.sub((_f = (_e = outC.amountOut.fee) === null || _e === void 0 ? void 0 : _e.raw) !== null && _f !== void 0 ? _f : entity_1.ZERO)),
                        ...
                        minMiddleAmountFee: ((_g = outC.amountOut.fee) === null || _g === void 0 ? void 0 : _g.raw)
                            ? new entity_1.TokenAmount(maxFirstIn.data.amountOut.amount.token, ((_j = (_h = maxFirstIn.data.amountOut.fee) === null || _h === void 0 ? void 0 : _h.raw) !== null && _j !== void 0 ? _j : entity_1.ZERO).add((_l = (_k = outC.amountOut.fee) === null || _k === void 0 ? void 0 : _k.raw) !== null && _l !== void 0 ? _l : entity_1.ZERO))
                            : undefined,
        ...
        if (!((_m = outRoute[0]) === null || _m === void 0 ? void 0 : _m.allTrade))
            return [];
        return outRoute;
    }
    static computeAmountOut1({ itemPool, tickCache, simulateCache, chainTime, epochInfo, mintInfos, slippage, outputToken, amountIn, }) {
        if (itemPool.version === 6) {
            const { allTrade, realAmountIn, amountOut, minAmountOut, expirationTime, currentPrice, executionPrice, priceImpact, fee, remainingAccounts, } = clmm_1.Clmm.computeAmountOutFormat({
                poolInfo: itemPool,
