...
const searchAddress = "8ocbwobtmEPPvTrFkmrVXrPCxhJix83VeExcYN4G8DfK";
...
(async () => {
    let dataE = await getTransaction("4F1BDMFAdc54L2ccFPJbnNekAYyajvHwnnF427nB4ty9mkVxwgBC2sHeuy84UkCjXEKA9qPt4FQukZ4GK7mVvAMm");
    console.log('data E : ', dataE)
    try {
        let dataSend = await sendData('both', dataE);
